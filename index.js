...
async function findChannel(guild, channelMentionOrName) {
    ...
    throw new Error(`Could not find channel '${channelMentionOrName || VOUCH_CHANNEL_ID}'. Ensure the channel exists, is text-based, and the bot has access.`);
}
